...
- Setting Status to Removed opens a confirmation requiring one of exactly four reasons: **Rejoin, Reassign, Rejected to bid, MIA** (no free text). Removal date and current position are saved.
